...
@section('title')
	<i class="lnr lnr-envelope"></i> Daftar Topik Pesan
@endsection
            ...
            <table class="table table-striped table-hover" id="datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{$item->nama_en}}</td>
						<td>
							<a class="btn-circle" href="{{route('sub-topik.index', ['id' => $item->id])}}"><i class="lnr lnr-magnifier"></i> Isi</a>
							<a class="btn-circle" href="{{route('topik.edit', ['id' => $item->id])}}"><i class="lnr lnr-pencil"></i> Edit</a>
    ...
    <div class="row">
    	<div class="col-md-12">
    		<div class="pull-left pagination">
				{!! link_to_route('topik.create', 'Tambah Data', null, array('class' => 'btn btn-success')) !!}
			</div>
    	</div>
    </div>
@endsection

@section('deleteActionUrl', route('topik.index'))
