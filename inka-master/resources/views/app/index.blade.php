...
<section class="carousel slide cid-qDtkpaow4r" data-interval="false" id="slider1-10" data-rv-view="1562">
    <div class="full-screen">
        <div class="mbr-slider slide carousel" data-pause="true" data-keyboard="false" data-ride="carousel" data-interval="7000">
            ...
            <img src="{{url('/')}}/assets/slider-label.png" class="slider-label-img">
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-md-9">
                            ...
                            @elseif($menu->nama == 'Stakeholder Relation')
                                    <div class="col-xs-6 col-sm-6 col-md-4 grid-item">
                                        ...
                                        @endforeach
                                            ...
                                            <li><a href="{{env('WBS_URL','wbs.inka.int')}}">Whistleblowing System</a></li>
                        ...
                        @endforeach
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 grid-item">
                                <h4>
                                @if(Session::get('lang') == 'id')Lainnya
                                    @elseif(Session::get('lang') == 'en')Other
                                    @endif
                                </h4>
                                <ul>
                                    <li><a href="{{ route('app.error') }}">
                                        Login
                                    </a></li>
                                </ul>
                            </div>
                ...
                <div class="socmed">
                    <a href="https://www.facebook.com/ptinkapersero" target="_blank" class="socmed-icon"><img src="{{url('/')}}/assets/socmed/facebook.png"></a>
                    <a href="https://twitter.com/ptinka" target="_blank" class="socmed-icon"><img src="{{url('/')}}/assets/socmed/twitter.png"></a>
                    <a href="https://www.instagram.com/pt_inka/" target="_blank" class="socmed-icon"><img src="{{url('/')}}/assets/socmed/instagram.png"></a>
                    <a href="https://id.linkedin.com/company/pt-industri-kereta-api" target="_blank" class="socmed-icon"><img src="{{url('/')}}/assets/socmed/linkedIn.png"></a>
                </div>
            </div>
            <!-- left -->
            ...
            <div class="col-sm-3">
                <div class="right-footer center">
                    <img src="{{url('/')}}/assets/cte2.png" class="footer-slogan">
                    ...
                    <img src="{{url('/')}}/assets/inka-border.png" class="footer-logo">
                </div>
            </div>
        </div>
    </div>
