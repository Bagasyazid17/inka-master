                    ...
                    <div>
                        <div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                            ...
                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                <a href="{{url('/')}}{{$item->link}}" itemprop="contentUrl" data-size="600x400">
                                    <div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="">
                                        <div href="#lb-gallery1-14" data-slide-to="{{$index}}" data-toggle="modal">
                                            <img src="{{url('/')}}{{$item->link}}" itemprop="thumbnail" alt="{{$item->nama}}" />
                                            <span class="icon-focus"></span>
                                            <span class="mbr-gallery-title mbr-fonts-style display-7">{{$item->nama}}</span>
                                        </div>
                                    </div>
                                </a>
                                <!-- <figcaption itemprop="caption description">{{$item->nama}}</figcaption> -->
                            </figure>
                            @endforeach
                        </div>
                    </div>
...
@push('stylesheets')
    <link rel="stylesheet" href="{{url('/')}}/photo-swipe/dist/photoswipe.css"> 
    <link rel="stylesheet" href="{{url('/')}}/photo-swipe/dist/default-skin/default-skin.css">
    <style type="text/css">
        .pswp{
            z-index: 9999;
        }
...
@push('scripts')
    <script src="{{url('/')}}/photo-swipe/dist/photoswipe.min.js"></script> 
    <script src="{{url('/')}}/photo-swipe/dist/photoswipe-ui-default.min.js"></script>
